...
public class KeyInFreeParkingSpotValues extends AppCompatActivity implements OnMapReadyCallback{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		((MapFragment) getFragmentManager().findFragmentById(
				R.id.freevacantparkinglotsmap)).getMapAsync(new OnMapReadyCallback() {
			@Override
			public void onMapReady(GoogleMap googleMap) {

				if (ActivityCompat.checkSelfPermission(KeyInFreeParkingSpotValues.this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(KeyInFreeParkingSpotValues.this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
