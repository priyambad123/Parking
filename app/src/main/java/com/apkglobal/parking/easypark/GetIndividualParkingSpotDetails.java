...
public class GetIndividualParkingSpotDetails extends ListActivity {
	...
	static final String getParkingSpotsurl =  Constants.IPAddress+ "/searchkero.com/nearbyparking/getparkingspots.php";
	static final String updateParkingSpoturl =  Constants.IPAddress +"/searchkero.com/nearbyparking/updateparkingspot.php";
